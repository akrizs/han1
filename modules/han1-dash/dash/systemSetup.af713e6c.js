...
},{}],"js/systemSetup.js":[function(require,module,exports) {
"use strict";
...
var han1Installation =
/*#__PURE__*/
function () {
  function han1Installation() {
    var _this = this;

    (0, _classCallCheck2.default)(this, han1Installation);
    this.progress = new _progressbar.default.Line('#setupProcessBar', {
      easing: 'easeInOut',
      color: '',
      strokeWidth: .5,
      svgStyle: {
    ...
    this.socket.on('defaultConfig', function (defConfig, serialList) {
      if (!_this.defaultConfigReceived) {
        _this.systemDefaultSettings = defConfig;
        _this.availableSerialPorts = serialList;

        _this.generatePages();

        _this.defaultConfigReceived = true;
      }

      console.log(_this.systemDefaultSettings);
    });
  ...
  (0, _createClass2.default)(han1Installation, [{
    key: "init",
    value: function () {
    ...
    key: "submitSettings",
    value: function submitSettings(e) {
      console.log('submit!');
    }
  }, {
    key: "generatePages",
    value: function generatePages(defConf) {
      var _this3 = this;

      defConf = defConf ? defConf : this.systemDefaultSettings;
      var pageTypes = this.pages.map(function (page, idx) {
        return [page.dataset.content, idx];
      });
      pageTypes.forEach(function (page) {
        var _page = (0, _slicedToArray2.default)(page, 2),
            name = _page[0],
            id = _page[1];

        if (name === 'intro') {
          generateIntroPage.call(_this3, id);
        } else if (name === 'general') {
          generateGeneralPage.call(_this3, id);
        } else if (name === 'meter') {
          generateMeterPage.call(_this3, id);
        } else if (name === 'dashboard') {
          generateDashboardPage.call(_this3, id);
        } else if (name === 'addons') {
          generateAddonsPage.call(_this3, id);
        } else if (name === 'storage') {
          generateStoragePage.call(_this3, id);
        } else if (name === 'review') {
          generateReviewPage.call(_this3, id);
        }
      });
    }
  }]);
  return han1Installation;
}();
...
function generateIntroPage(id) {
  ...
  page.querySelector('h4.version').innerText = "ver. ".concat(this.systemDefaultSettings.version);
}
...
function generateGeneralPage(id) {
  ...
  var serialPorts = this.availableSerialPorts.map(function (sp) {
    var string;
    string = sp.manufacturer === undefined ? "".concat(sp.comName) : "".concat(sp.manufacturer.trim(), ": ").concat(sp.comName);
    return [string, sp.comName];
  }); // Host & Log level

  var DOMHostAndLog = document.createElement('div');
  DOMHostAndLog.classList.add('hostAndLog');
  var DOMDebugEnabled = document.createElement('input');
  DOMDebugEnabled.type = 'checkbox';
  var DOMHost = generateSelectElements('host', this.systemDefaultSettings.host);
  var DOMLogLevel = generateSelectElements('loglevel', this.systemDefaultSettings.log);
  DOMHostAndLog.appendChild(DOMHost);
  DOMHostAndLog.appendChild(DOMDebugEnabled);
  DOMHostAndLog.appendChild(DOMLogLevel); // Serial Connection values!

  var DOMSerialPort = document.createElement('div');
  var DOMSerials = generateSelectElements('serialPort', serialPorts);
  var DOMSerialBaudRate = document.createElement('input');
  var DOMSerialDataBits = document.createElement('input');
  var DOMSerialStopBits = document.createElement('input');
  var DOMSerialParity = generateSelectElements('serialParity', this.systemDefaultSettings.serial.parity);
...
function generateMeterPage(id) {
  var page = this.pages[id];
  var content = document.createElement('div');
  content.classList.add('settingsArea'); // MeterInfo

  var DOMMeter = document.createElement('div');
  var DOMMeterManufacturer = generateSelectElements('serialParity', this.systemDefaultSettings.meter.manufacturer);
  var DOMMeterId = document.createElement('input');
  var DOMMeterSerial = document.createElement('input');
  var DOMMeterType = document.createElement('input');
...
function generateDashboardPage(id) {
  ...
  var content = document.createElement('div');
  content.classList.add('settingsArea');
  var DOMDash = document.createElement('div');
  var DOMDashApi = document.createElement('input');
  DOMDashApi.type = 'checkbox';
  var DOMDashPort = document.createElement('input');
...
},{"@babel/runtime/helpers/slicedToArray":"../node_modules/@babel/runtime/helpers/slicedToArray.js","@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/helpers/classCallCheck":"../node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"../node_modules/@babel/runtime/helpers/createClass.js","progressbar.js":"../node_modules/progressbar.js/src/main.js","./modules/loadingScreen":"js/modules/loadingScreen.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
var b=require("../node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("../node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.load([]).then(function(){require("js/systemSetup.js");});
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js",0], null)
//# sourceMappingURL=systemSetup.af713e6c.map