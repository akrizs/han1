...
},{"./objectWithoutPropertiesLoose":"../node_modules/@babel/runtime/helpers/objectWithoutPropertiesLoose.js"}],"js/main.js":[function(require,module,exports) {
"use strict";
...
var activeWmeter = new ProgressBar.SemiCircle(activePower.querySelector('.meter'), metersOptions.activeMeterOpts);
activeWmeter.text.removeAttribute('style');
activeWmeter.path.setAttribute('stroke-linecap', 'round');
var l1 = document.all.l1;
var il1Meter = new ProgressBar.SemiCircle(l1.querySelector('.current'), metersOptions.ampsMetersOpts);
il1Meter.path.setAttribute('stroke-linecap', 'round');
il1Meter.text.removeAttribute('style');
var vl1Meter = new ProgressBar.SemiCircle(l1.querySelector('.volt'), metersOptions.voltMetersOpts);
vl1Meter.path.setAttribute('stroke-linecap', 'round');
vl1Meter.text.removeAttribute('style');
var l2 = document.all.l2;
var il2Meter = new ProgressBar.SemiCircle(l2.querySelector('.current'), metersOptions.ampsMetersOpts);
il2Meter.path.setAttribute('stroke-linecap', 'round');
il2Meter.text.removeAttribute('style');
var vl2Meter = new ProgressBar.SemiCircle(l2.querySelector('.volt'), metersOptions.voltMetersOpts);
vl2Meter.path.setAttribute('stroke-linecap', 'round');
vl2Meter.text.removeAttribute('style');
var l3 = document.all.l3;
var il3Meter = new ProgressBar.SemiCircle(l3.querySelector('.current'), metersOptions.ampsMetersOpts);
il3Meter.path.setAttribute('stroke-linecap', 'round');
il3Meter.text.removeAttribute('style');
var vl3Meter = new ProgressBar.SemiCircle(l3.querySelector('.volt'), metersOptions.voltMetersOpts);
...
},{"@babel/runtime/helpers/objectWithoutProperties":"../node_modules/@babel/runtime/helpers/objectWithoutProperties.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
